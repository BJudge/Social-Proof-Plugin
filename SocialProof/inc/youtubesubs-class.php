...
class Youtube_Subs_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		echo $args['before_widget']; // whatever you want to display before widget (etc div tags)
		...
		echo $args['after_widget']; // whatever you want to display after widget (etc closing div tags)
	}
	 ...
	 */
     ...
     //what does the user see on the back-end
	public function form( $instance ) {
        $title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'YouTube Subs', 'yts_domain' );
        
        $channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'UC5-jCKRC6A4pb4sH2ycFBlA', 'yts_domain' );
		...
		<select 
        class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'Layout' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'layout' ) ); ?>">
		...
		<select 
        class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'count' ) ); ?>">
